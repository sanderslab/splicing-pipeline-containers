...
LOCAL_NAME=splicing-misc-processing
DIR_NAME=splicing-misc-processing

RKSTR8_REL_PATH=../../rkstr8
RKSTR8_REQS_REL_PATH=../../requirements.small.txt

MASTER_SCRIPT=run_splicing-misc-processing.py

AWS_CONFIG_LOCAL=config

USER_NAME=$1
REPOSITORY_NAME=splicing-misc-processing
